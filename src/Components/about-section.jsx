...
const dataKonten = [
  {
    ...
    deskripsi: "Dapatkan pengalaman dengan belajar di SINTAK."
    },
    {
    ikon: Book,
          ...
          <div className='flex flex-col px-4 items-center justify-center max-w-7xl mx-auto gap-6'>
              ...
              <div className='text-center space-y-4'>
                  ...
                  <p className='text-gray-500'>
                      ...
                      Group on Campus POLSRI untuk memperkenalkan mahasiswa pada pengembangan web modern menggunakan React dan Next.js dengan bantuan AI.
                  </p>
              </div>
